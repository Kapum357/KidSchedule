    ...
    <footer className="bg-gray-950 text-white pt-16 pb-8 border-t border-gray-800">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">KidSchedule</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs mb-6">
              The #1 app for co-parenting and family organization. Secure, simple,
              and built with love.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>© 2024 KidSchedule Inc. All rights reserved.</p>
