...
export async function generateExport(job: ExportJobRecord): Promise<ExportResult> {
  const type = job.type;
  let generator: (job: ExportJobRecord) => Promise<ExportResult>;
  switch (type) {
    case "schedule-pdf":
      generator = generateSchedulePdf;
      break;
    case "invoices-pdf":
      generator = generateInvoicesPdf;
      break;
    case "messages-csv":
      generator = generateMessagesCsv;
      break;
    case "moments-archive":
      generator = generateMomentsArchive;
      break;
    case "custody-compliance-pdf":
      generator = generateCustodyCompliancePdfExport;
      break;
    case "message-transcript-pdf":
      generator = generateMessageTranscriptPdfExport;
      break;
    case "communication-report":
      generator = generateCommunicationReportExport;
      break;
    default:
